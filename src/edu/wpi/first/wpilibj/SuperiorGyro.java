 ...
 */
public class SuperiorGyro extends SensorBase implements PIDSource, LiveWindowSendable {

	static final int kOversampleBits = 10;
	static final int kAverageBits = 0;
	static final double kSamplesPerSecond = 50.0;
	static double kCalibrationSampleTime = 1.0;
	static final double kDefaultVoltsPerDegreePerSecond = 0.00167698;//0.001637;
	 ...
	 */
	public SuperiorGyro(int channel, double calibrationTime) {
		this(new AnalogInput(channel), calibrationTime);
	 ...
	 */
	public SuperiorGyro(AnalogInput channel, double calibrationTime) {
		kCalibrationSampleTime = calibrationTime;
		m_analog = channel;
		if (m_analog == null) {
	...
	public double getAngle() {
		//System.out.println(m_analog.getVoltage());
		if (m_analog == null) {
			return 0.0;
		} else {
			m_analog.getAccumulatorOutput(result);
			...
			return -scaledValue; //INVERTED BY IRON DEVIS. FOR NEW GUYRO
		}
	}
